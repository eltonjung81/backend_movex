...
# Modificar a configuração do WhiteNoise para excluir caminhos importantes
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
WHITENOISE_ROOT = None  # Desativa o root serving
# Adicionar configuração para o WhiteNoise não interceptar URLs do admin
WHITENOISE_AUTOREFRESH = True  # Recarrega arquivos estáticos automaticamente durante o desenvolvimento
WHITENOISE_USE_FINDERS = True  # Usa os finders do Django para localizar arquivos estáticos
WHITENOISE_INDEX_FILE = False  # Desativa o servimento de index.html
